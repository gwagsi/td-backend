 ...
 * @author Sorelus
 */
public class TruckManagementException extends Exception{
    ...
    public TruckManagementException(String classe,String fonction,int code,String sMess, String message){
      super(message);
