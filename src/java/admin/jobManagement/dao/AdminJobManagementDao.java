...
import resultInfo.JobAdminInfo;
...
public class AdminJobManagementDao implements IAdminJobManagementDaoRemote , IAdminJobManagementDaoLocal {
    ...
    public String applyActionToUser(int accountID, String admin, int actionID, String message)throws AdminJobManagementException {
        ...
        try{
            ...
            // System.out.println("" + res);
              throw new AdminJobManagementException(getClass()+"","applyActionToUser",1,res,res);
    ...
    public Result getARangeOfCategorieJobs(String categorie, boolean categorieValue, int index, int nombreMaxResult) throws AdminJobManagementException{
        ...
        try{
            ...
            throw new AdminJobManagementException("AdminAccountManagementDao","applyActionToUser",1,res,res);
    ...
    public String getJobsStatisticsInDateRange(long statDate, long endDate) throws AdminJobManagementException{
        ...
        if (statictics.hasNext()) {
           ...
           // System.out.println("[getJobsStatisticsInDateRange] object.length: " + object.length);
             ...
             logger.info("\n"+"Class : "+getClass()+"\n"
                            +"Fct       : "+"getJobsStatisticsInDateRange"+"\n"
                            +"info      : "+ "[getJobsStatisticsInDateRange] object.length: " + object.length);
            ...
            numberOfAllJob = object[5] == null ? 0 : Long.parseLong(String.valueOf(object[5]));
               ...
               logger.info("\n"+"Class : "+getClass()+"\n"
                            +"Fct       : "+"getJobsStatisticsInDateRange"+"\n"
                            +"info      : "+ "[getJobsStatisticsInDateRange] Return Order: NBPostedJob ## NBClosedJob ## NBDeletedJob ## NBActifJob ## NBPassedJob ## NBAllJob"+"\n"+
                            "[getJobsStatisticsInDateRange] data: " + numberOfPostedJob + "##" + numberOfClosedJob + "##" + numberOfDeletedJob + "##" + numberOfStartedJob + "##" + numberOfPassedJob  + "##" + numberOfAllJob);
