 ...
 * @author erman
 */
public class MailSendingJobRejection implements Runnable {
    
    private Result result = null;

    public MailSendingJobRejection (Result result) {
        this.result = result;
    }
    
    public String sendMailJobRejection() {

        String res = "envoyé";
        MailFunction mf = new MailFunction();
        String subject = "Trucksanddirt: Job Rejection";
    ...
    public CustomMail getMailJobRejectionMessage (String truckOwnerTotalName, String jobNumber, String jobLocation, String jobStartDate, String jobEndDate, String excavatorTotalName, String gwtUrl, String hourPerDayRtn, String numberOfTruckRtn, MailFunction mf, String jobDescription, String jobInstruction, String excavatorEmail, String telephone, String cellPhone, String dotNumber, String generalLiability, String truckLiability, String proofOfTruckLiability, String lenghtOfBed, String truckAxle) {
        ...
        CustomMail ctMail = new CustomMail(hashValues, FileMessageContent.MAIL_JobRejectionMessageContent);
        ctMail.buildMail();
        return ctMail;
    }
