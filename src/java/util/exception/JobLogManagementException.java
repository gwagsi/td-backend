 ...
 * @author Sorelus
 */
public class JobLogManagementException extends Exception{
    ...
    public JobLogManagementException(String classe,String fonction,int code,String sMess, String message){
      super(message);
