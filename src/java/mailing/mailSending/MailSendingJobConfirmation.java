 ...
 * @author erman
 */
public class MailSendingJobConfirmation implements Runnable {

    private Result result = null;

    public MailSendingJobConfirmation(Result result) {
        this.result = result;
    }

    public String sendMailJobConfirmation() {

        String res = "envoyé";
        MailFunction mf = new MailFunction();
        String subject = "Trucksanddirt: Job Confirmation";
        ...
        String truckNumbers = result.getObject().split("##")[3];
        ...
        //String jobStartDate = DateFunction.formatDateToStringMMMDY(DateFunction.parseSLongToDate(jobResponseInfo[0]));
        //String jobEndDate = DateFunction.formatDateToStringMMMDY(DateFunction.parseSLongToDate(jobResponseInfo[1]));
        ...
        CustomMail custMail = getMailJobConfirmationMessage(truckOwnerTotalName, jobNumber, jobLocation, jobStartDate, jobEndDate, excavatorTotalName, gwtUrl, hourPerDayRtn, numberOfTruckRtn, mf, jobDescription, jobInstruction, excavatorEmail, telephone, cellPhone, dotNumber, generalLiability, truckLiability, proofOfTruckLiability, lenghtOfBed, truckAxle, truckNumbers);

        MailSender mailSender = new MailSender();
        String sendState = mailSender.sendMail(truckOwnerEmail, custMail, subject);

        System.out.println("sendMailJobConfirmation : To truckOwnerEmail:  " + truckOwnerEmail + "  -   sendState: " + sendState);

        return res;
    }

    public CustomMail getMailJobConfirmationMessage(String truckOwnerTotalName, String jobNumber, String jobLocation, String jobStartDate, String jobEndDate, String excavatorTotalName, String gwtUrl, String hourPerDayRtn, String numberOfTruckRtn, MailFunction mf, String jobDescription, String jobInstruction, String excavatorEmail, String telephone, String cellPhone, String dotNumber, String generalLiability, String truckLiability, String proofOfTruckLiability, String lenghtOfBed, String truckAxle, String truckNumbers) {
        ...
        hashValues.put("###TRUCKS_NUMBER", truckNumbers);
        CustomMail ctMail = new CustomMail(hashValues, FileMessageContent.MAIL_JobConfirmationMessageContent);
        ctMail.buildMail();
        return ctMail;
