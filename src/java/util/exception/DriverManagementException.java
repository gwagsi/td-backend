 ...
 * @author Sorelus
 */
public class DriverManagementException extends Exception{
    ...
    public DriverManagementException(String classe,String fonction,int code,String sMess, String message){
      super(message);
