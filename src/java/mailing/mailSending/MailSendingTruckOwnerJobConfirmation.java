 ...
 * @author erman
 */
public class MailSendingTruckOwnerJobConfirmation implements Runnable {

    private Result result = null;

    public MailSendingTruckOwnerJobConfirmation(Result result) {
        this.result = result;
    }

    public String sendTruckOwnerJobConfirmationMail() {

        String res = "envoyé";
        MailFunction mf = new MailFunction();
        String subject = "Trucksanddirt: Job Request Confirmation";
        ...
        CustomMail custMail = getJobConfirmationTruckOwnerMessage(excavatorTotalName, jobNumber, jobLocation, jobStartDate, jobEndDate, truckOwnerTotalName, gwtUrl, hourPerDayRtn, numberOfTruckRtn, mf, jobDescription, jobInstruction, truckOwnerEmail, telephone, cellPhone, dotNumber, generalLiability, truckLiability, proofOfTruckLiability, lenghtOfBed, truckAxle, truckNumbers);

        MailSender mailSender = new MailSender();
        String sendState = mailSender.sendMail(excavatorEmail, custMail, subject);

        System.out.println("sendTruckOwnerJobConfirmationMail : To excavatorEmail:  " + excavatorEmail + "  -   sendState: " + sendState);

        return res;
    }

    public CustomMail getJobConfirmationTruckOwnerMessage(String excavatorTotalName, String jobNumber, String jobLocation, String jobStartDate, String jobEndDate, String truckOwnerTotalName, String gwtUrl, String hourPerDayRtn, String numberOfTruckRtn, MailFunction mf, String jobDescription, String jobInstruction, String truckOwnerEmail, String telephone, String cellPhone, String dotNumber, String generalLiability, String truckLiability, String proofOfTruckLiability, String lenghtOfBed, String truckAxle, String truckNumbers) {
        ...
        CustomMail ctMail = new CustomMail(hashValues, FileMessageContent.MAIL_JobConfirmTruckOwnerMessageContent);
        ctMail.buildMail();
        return ctMail;
    ...
    @Override
    public void run() {
        sendTruckOwnerJobConfirmationMail();
    }
